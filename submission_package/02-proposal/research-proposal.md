...
**Working title:** AI Tools and Founder Decision-Making Speed and Quality in Early-Stage Startups: A Systematic Literature Review

**Author:** Duy Bui, Eastern International University (EIU)
...
> **How do AI tools affect founder decision-making speed and quality in early-stage startups?**

Subsidiary questions: (a) what themes organize the empirical evidence; (b) where does the evidence converge and where does it conflict; (c) what boundary conditions explain the conflicting findings; (d) what agenda follows for empirical research?
...
1. First consolidated evidence map of AI-enabled founder decision-making (speed *and* quality).
2. A quantified consensus analysis making the field's disagreement explicit and analyzable.
3. A contingency perspective with testable propositions reconciling the divergent evidence.
4. A fully transparent, reproducible protocol: review matrix, stance data, verification reports, and provenance records are released with the manuscript.
