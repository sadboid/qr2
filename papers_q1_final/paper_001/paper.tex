...
**Results**: Analysis of the corpus (92\textbackslash{}% from the last 3 years) reveals convergent findings across multiple research groups. Key findings indicate that the results indicate that genai adoption increases creative self-efficacy but exerts no direct effect on opportunity recognition.
